...
import com.tuya.smart.android.Young.base.utils.ViewUtils;
import com.tuya.smart.android.Young.base.widget.circleprogress.CircleProgressView;
...
public class ECBindActivity extends BaseActivity implements IECBindView {
    ...
    private void initView() {
        ...
        int color = ViewUtils.getColor(this, R.color.status_system_bg_color);
