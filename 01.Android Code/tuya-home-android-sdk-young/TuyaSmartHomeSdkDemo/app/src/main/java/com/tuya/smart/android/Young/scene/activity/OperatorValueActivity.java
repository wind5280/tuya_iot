...
import com.tuya.smart.android.Young.scene.adapter.SceneOperatorAdapter;
...
import com.tuya.smart.android.Young.test.widget.NumberPicker;
...
public class OperatorValueActivity extends BaseActivity implements IOperatorValueView, SceneOperatorAdapter.OnItemClickListener {
    ...
    private void initMenu() {
        ...
        setMenu(R.menu.toolbar_next, new Toolbar.OnMenuItemClickListener() {  //下一步
            @Override
