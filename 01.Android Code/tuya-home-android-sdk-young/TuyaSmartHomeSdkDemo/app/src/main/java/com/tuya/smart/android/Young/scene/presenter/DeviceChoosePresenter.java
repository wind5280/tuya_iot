...
import com.tuya.smart.android.Young.scene.activity.OperateorListActivity;
...
import com.tuya.smart.android.Young.scene.event.ScenePageCloseEvent;
import com.tuya.smart.android.Young.scene.event.model.ScenePageCloseModel;
import com.tuya.smart.android.Young.scene.view.IDeviceChooseView;
...
public class DeviceChoosePresenter extends BasePresenter implements ScenePageCloseEvent {
    ...
    public void getDeviceOperatorList(DeviceBean deviceBean) {
        ...
        intent.putExtra(DEV_ID, deviceBean.getDevId());  //传递设备id
