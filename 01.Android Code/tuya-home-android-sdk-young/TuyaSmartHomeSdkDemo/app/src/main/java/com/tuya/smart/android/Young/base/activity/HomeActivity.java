package com.tuya.smart.android.Young.base.activity;
...
import com.tuya.smart.android.Young.base.presenter.HomePresenter;
import com.tuya.smart.android.Young.base.utils.ActivityUtils;
import com.tuya.smart.android.Young.base.view.IHomeView;
import com.tuya.smart.android.Young.family.activity.FamilyEmptyActivity;
...
public class HomeActivity extends BaseActivity implements IHomeView {
    ...
    private int mFuncBarTextSelectColor = Color.parseColor("#039BE5");
    ...
    protected void initView() {
        ...
        mIvMyDevice.setImageResource(R.drawable.ty_mydevice);
        ...
        mIvHomeCenter.setImageResource(R.drawable.ty_home_center);
    ...
    public void onItem(int id) {
        switch (id) {
            case HomePresenter.TAB_MY_DEVICE:
                ...
                mIvMyDevice.setColorFilter(mFuncBarTextSelectColor);
                mIvMyDevice.setImageResource(R.drawable.ty_mydevice_selected);
                mFragmentContainer.setCurrentItem(idToPosition(id), true);  //平滑
                break;
            case HomePresenter.TAB_PERSONAL_CENTER:
                ...
                mIvHomeCenter.setImageResource(R.drawable.ty_home_center_selected);
