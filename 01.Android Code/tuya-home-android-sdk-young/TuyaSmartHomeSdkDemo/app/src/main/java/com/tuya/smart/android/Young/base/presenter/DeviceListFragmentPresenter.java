...
import com.tuya.smart.android.Young.base.activity.BrowserActivity;
import com.tuya.smart.android.Young.base.app.Constant;
import com.tuya.smart.android.Young.base.fragment.DeviceListFragment;
import com.tuya.smart.android.Young.base.utils.ActivityUtils;
import com.tuya.smart.android.Young.base.utils.DialogUtil;
import com.tuya.smart.android.Young.base.utils.ProgressUtil;
...
import com.tuya.smart.android.Young.camera.CameraPanelActivity;
import com.tuya.smart.android.Young.config.AddDeviceTypeActivity;
import com.tuya.smart.android.Young.config.CommonConfig;
import com.tuya.smart.android.Young.device.CommonDeviceDebugActivity;
import com.tuya.smart.android.Young.device.LampActivity;
import com.tuya.smart.android.Young.device.SwitchActivity;
import com.tuya.smart.android.Young.device.common.CommonDeviceDebugPresenter;
import com.tuya.smart.android.Young.shortcut.ShortcutDeviceActivity;
                                ...
                                DialogUtil.simpleConfirmDialog(mActivity, mActivity.getString(R.string.device_confirm_remove), new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if (which == DialogInterface.BUTTON_POSITIVE) {
                                            unBindDevice(deviceBean);  //取消绑定设备
                                        }
                                    }
                                });
                            }
    ...
    protected void onItemClick(DeviceBean devBean) {
        ...
        if (standardProduct) {
            ...
            if (category.equals("dj") && (type == LightType.TYPE_RGB || type == LightType.TYPE_RGBC || type == LightType.TYPE_RGBCW)) {
                Intent intent = new Intent(mActivity, LampActivity.class);  //跳转目标activity
                intent.putExtra(SwitchActivity.INTENT_DEVID, devBean.getDevId());//传递信息
                mActivity.startActivity(intent);
            } else {
