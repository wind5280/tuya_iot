...
import com.tuya.smart.android.Young.scene.bean.OperatorBean;
import com.tuya.smart.android.Young.scene.event.model.ScenePageCloseModel;
...
import com.tuya.smart.android.Young.scene.view.IOperatorValueView;
...
import static com.tuya.smart.android.Young.scene.event.model.ScenePageCloseModel.DEFAULT_CLOSE;
...
public class OperatorValuePresenter extends BasePresenter {
    ...
    private void saveTask() {
        if(TextUtils.equals(mTaskListBean.getType(),ValueProperty.type)){
            ...
            dpid=mTaskListBean.getDpId();
            device_id = mDevId;
            ToastUtil.shortToast(mAc,"4/"+ actionDisplayNew);
            mAc.finish();
        } else {
            ...
            /**key:mTaskListBean.getDpId(), value:mOperatorBean.getKey()*/
            ...
            ToastUtil.shortToast(mAc,"3/"+ actionDisplayNew);
            mAc.finish();//
        }
    }
    ...
    private void saveCondition() {
        if(TextUtils.equals(mTaskListBean.getType(),ValueProperty.type)){
            ...
            if(null != deviceBean){
                ...
                ToastUtil.shortToast(mAc,"2/"+ (int) mTaskListBean.getDpId());
                mAc.finish();
            }else {
            ...
            if(null != deviceBean){
                ...
                ToastUtil.shortToast(mAc,"1/"+ (int) mTaskListBean.getDpId());
                mAc.finish();
            }else {
                ToastUtil.shortToast(mAc, R.string.ty_scene_device_is_not_exsit);
            }
