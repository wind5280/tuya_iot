...
import com.tuya.smart.android.Young.scene.adapter.SmartAdapter;
...
import static com.tuya.smart.android.Young.base.presenter.SceneListPresenter.SMART_TYPE_SCENE;
...
public class SceneFragment extends BaseFragment implements ISceneListFragmentView, View.OnClickListener {
    ...
    private void initView() {
        ...
        mRcv_scene_list = mContentView.findViewById(R.id.rcv_scene_list); //场景列表
