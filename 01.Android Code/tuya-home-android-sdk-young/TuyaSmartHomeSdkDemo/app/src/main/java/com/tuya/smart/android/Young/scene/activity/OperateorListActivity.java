...
import com.tuya.smart.android.Young.scene.adapter.OperatroListAdapter;
import com.tuya.smart.android.Young.scene.presenter.OperatorListPresenter;
...
public class OperateorListActivity extends BaseActivity implements IOperatorListView, OperatroListAdapter.OnItemClickListener {
    ...
    public void onItemClick(TaskListBean taskListBean) {
        mPresenter.selectOperatorValue(taskListBean);   //操作值
    }
