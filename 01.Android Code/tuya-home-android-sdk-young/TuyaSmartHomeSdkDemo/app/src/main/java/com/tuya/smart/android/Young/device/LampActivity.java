package com.tuya.smart.android.Young.device;
...
import com.tuya.smart.android.Young.base.presenter.LampPresenter;
import com.tuya.smart.android.Young.base.utils.AnimationUtil;
import com.tuya.smart.android.Young.base.utils.ToastUtil;
import com.tuya.smart.android.Young.base.view.ILampView;
import com.tuya.smart.android.Young.base.widget.ColorPicker;
import com.tuya.smart.android.Young.base.widget.LampView;
...
public class LampActivity extends BaseActivity implements ILampView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lamp);   //页面布局
    ...
    public void showOperationView() {
        ...
        AnimationUtil.translateView(mOperationView, Animation.RELATIVE_TO_SELF, 0f,
            ...
            Animation.RELATIVE_TO_SELF, 0f, 50, false, null);
    }
    ...
    public void onClickArrawUp() {
        AnimationUtil.translateView(mOperationView, Animation.RELATIVE_TO_SELF, 0f,
            Animation.RELATIVE_TO_SELF, 0f,
            Animation.RELATIVE_TO_SELF, 0f,
            Animation.RELATIVE_TO_SELF, 1f, 50, false, new Animation.AnimationListener() {
                @Override
